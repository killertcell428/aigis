...
> 作成日: 2026-04-11
>
> **本文書は 2026-08-14 時点で失効しています。** 現在の方針は [ROADMAP.md](../ROADMAP.md)
> が正本です。ここで前提としている「汎用エージェントセキュリティ」という位置付けと
> SaaS 階層は撤回され、本文が言及する Atomic Execution Pipeline / Safety Specification は
> v2.0 の整理で削除されました。当時の記録として保存しています。
